...
# Form implementation generated from reading ui file 'sub1_win_v7_1.ui'
#
...
class Ui_Dialog_tool(object):
    def setupUi(self, Dialog_tool):
        ...
        self.sub1_console_plainTextEdit.setGeometry(QtCore.QRect(110, 350, 301, 61))
        ...
        self.sub1_start_pushButton.setGeometry(QtCore.QRect(40, 360, 51, 31))
        ...
        self.sub1_intp_comboBox.setGeometry(QtCore.QRect(80, 50, 111, 21))
        ...
        self.lambda_Slider = QtWidgets.QSlider(self.sub1_deold_tab)
        self.lambda_Slider.setGeometry(QtCore.QRect(90, 40, 121, 22))
        self.lambda_Slider.setOrientation(QtCore.Qt.Horizontal)
        self.lambda_Slider.setObjectName("lambda_Slider")
        self.sigma_Slider = QtWidgets.QSlider(self.sub1_deold_tab)
        self.sigma_Slider.setGeometry(QtCore.QRect(90, 90, 121, 22))
        self.sigma_Slider.setOrientation(QtCore.Qt.Horizontal)
        self.sigma_Slider.setObjectName("sigma_Slider")
        self.iter_frames_Slider = QtWidgets.QSlider(self.sub1_deold_tab)
        self.iter_frames_Slider.setGeometry(QtCore.QRect(90, 140, 121, 22))
        self.iter_frames_Slider.setOrientation(QtCore.Qt.Horizontal)
        self.iter_frames_Slider.setObjectName("iter_frames_Slider")
        self.crop_size_h = QtWidgets.QSlider(self.sub1_deold_tab)
        self.crop_size_h.setGeometry(QtCore.QRect(90, 190, 121, 22))
        ...
        self.crop_size_w.setGeometry(QtCore.QRect(90, 240, 121, 22))
        self.crop_size_w.setOrientation(QtCore.Qt.Horizontal)
        self.crop_size_w.setObjectName("crop_size_w")
        self.label_7 = QtWidgets.QLabel(self.sub1_deold_tab)
        self.label_7.setGeometry(QtCore.QRect(5, 40, 81, 16))
        self.label_7.setObjectName("label_7")
        self.label_8 = QtWidgets.QLabel(self.sub1_deold_tab)
        self.label_8.setGeometry(QtCore.QRect(5, 90, 81, 16))
        self.label_8.setObjectName("label_8")
        self.label_9 = QtWidgets.QLabel(self.sub1_deold_tab)
        self.label_9.setGeometry(QtCore.QRect(5, 140, 81, 16))
        self.label_9.setObjectName("label_9")
        self.label_10 = QtWidgets.QLabel(self.sub1_deold_tab)
        self.label_10.setGeometry(QtCore.QRect(5, 190, 81, 16))
        self.label_10.setObjectName("label_10")
        self.label_11 = QtWidgets.QLabel(self.sub1_deold_tab)
        self.label_11.setGeometry(QtCore.QRect(5, 240, 81, 16))
        self.label_11.setObjectName("label_11")
        self.spinBox = QtWidgets.QSpinBox(self.sub1_deold_tab)
        self.spinBox.setGeometry(QtCore.QRect(220, 40, 42, 22))
        self.spinBox.setObjectName("spinBox")
        self.sigma_spinBox = QtWidgets.QSpinBox(self.sub1_deold_tab)
        self.sigma_spinBox.setGeometry(QtCore.QRect(220, 90, 42, 22))
        self.sigma_spinBox.setObjectName("sigma_spinBox")
        self.iter_frames_spinBox = QtWidgets.QSpinBox(self.sub1_deold_tab)
        self.iter_frames_spinBox.setGeometry(QtCore.QRect(220, 140, 42, 22))
        self.iter_frames_spinBox.setObjectName("iter_frames_spinBox")
        self.crop_size_h_spinBox = QtWidgets.QSpinBox(self.sub1_deold_tab)
        self.crop_size_h_spinBox.setGeometry(QtCore.QRect(220, 190, 42, 22))
        ...
        self.crop_size_w_spinBox_2.setGeometry(QtCore.QRect(220, 240, 42, 22))
        self.crop_size_w_spinBox_2.setObjectName("crop_size_w_spinBox_2")
        self.line_2 = QtWidgets.QFrame(self.sub1_deold_tab)
        self.line_2.setGeometry(QtCore.QRect(280, -60, 21, 361))
        self.line_2.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.groupBox = QtWidgets.QGroupBox(self.sub1_deold_tab)
        self.groupBox.setGeometry(QtCore.QRect(290, 10, 171, 291))
        self.groupBox.setObjectName("groupBox")
        self.color_mode1 = QtWidgets.QRadioButton(self.groupBox)
        self.color_mode1.setGeometry(QtCore.QRect(10, 60, 89, 16))
        self.color_mode1.setObjectName("color_mode1")
        self.color_mode2 = QtWidgets.QRadioButton(self.groupBox)
        self.color_mode2.setGeometry(QtCore.QRect(10, 110, 89, 16))
        self.color_mode2.setObjectName("color_mode2")
        self.color_mode3 = QtWidgets.QRadioButton(self.groupBox)
        self.color_mode3.setGeometry(QtCore.QRect(10, 160, 89, 16))
        self.color_mode3.setObjectName("color_mode3")
        self.color_mode4 = QtWidgets.QRadioButton(self.groupBox)
        self.color_mode4.setGeometry(QtCore.QRect(10, 210, 89, 16))
        self.color_mode4.setObjectName("color_mode4")
    ...
    def retranslateUi(self, Dialog_tool):
        ...
        self.label_7.setText(_translate("Dialog_tool", "lambda_value"))
        self.label_8.setText(_translate("Dialog_tool", "sigma_color"))
        self.label_9.setText(_translate("Dialog_tool", "iter frames"))
        self.label_10.setText(_translate("Dialog_tool", "crop size h"))
        self.label_11.setText(_translate("Dialog_tool", "crop size w"))
        self.groupBox.setTitle(_translate("Dialog_tool", "上色模式"))
        self.color_mode1.setText(_translate("Dialog_tool", "色彩模式1"))
        self.color_mode2.setText(_translate("Dialog_tool", "色彩模式2"))
        self.color_mode3.setText(_translate("Dialog_tool", "色彩模式3"))
        self.color_mode4.setText(_translate("Dialog_tool", "色彩模式4"))
