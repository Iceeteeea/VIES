...
def get_one_color_scribble(baseroot, saveroot, crop_size_h, crop_size_w):
    ...
    parser.add_argument('--crop_size_w', type = int, default = 432, help = 'single patch size')
    ...
    for i in range(N):
        ...
        save_resized_scribble_name = os.path.join(saveroot, imgname.split('.')[0] + '.png')
