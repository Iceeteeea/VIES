...
import models.color_models.SVCNet.core.datasets.data_utils as dutils
import models.color_models.SVCNet.core.networks.pwcnet as pwcnet
import models.color_models.SVCNet.core.utils as utils
...
def main_worker_SVCNet(save_rgb_path, lambda_value=500, sigma_color=4, pad='zero', base_root=None, scribble_root=None, iter_frames=7, crop_size_h=256, crop_size_w=448, use_scribble=True ):
    transform_from_PIL = dutils.create_transform(opt)
    opt.save_rgb_path = save_rgb_path
    opt.lambda_value = lambda_value
    opt.sigma_color = sigma_color
    opt.pad = pad
    opt.base_root = base_root
    opt.scribble_root = scribble_root
    opt.iter_frames = iter_frames
    opt.crop_size_h = crop_size_h
    opt.crop_size_w = crop_size_w
    opt.use_scribble = use_scribble
    # ----------------------------------------
...
if __name__ == '__main__':
    main_worker_SVCNet(save_rgb_path='./results', base_root='./test_data/input', scribble_root='./test_data/color_point40_color_width5_256p_diverse1')
