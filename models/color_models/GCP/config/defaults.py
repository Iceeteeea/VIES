...
_C.DATA.USER_IMAGENET_LABEL = 'tmp/predicted_label_for_user_image.txt'

_C.MODEL = CfgNode()
_C.MODEL.NAME = 'REFCOLOR'

_C.DIVERSE = CfgNode()
_C.DIVERSE.CKP = 'models/color_models/GCP/checkpoints/deformator_for_biggan.pt'
_C.DIVERSE.DIRECTION = -2
_C.DIVERSE.SHIFT_RANGE = 16
_C.DIVERSE.SHIFT_COUNT = 3

_C.TEST = CfgNode()
_C.TEST.LOAD_FROM = 'models/color_models/GCP/checkpoints/colorization_model.pth'

_C.BIGGAN_PRETRAIN = CfgNode()
_C.BIGGAN_PRETRAIN.DIS = 'models/color_models/GCP/checkpoints/biggan_D_256.pth'
_C.BIGGAN_PRETRAIN.ENC = 'models/color_models/GCP/checkpoints/biggan_E.pth'
_C.BIGGAN_PRETRAIN.GEN = 'models/color_models/GCP/checkpoints/biggan_G_ema_256.pth'
