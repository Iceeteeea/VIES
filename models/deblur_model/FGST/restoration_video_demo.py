...
def parse_args():
    ...
    parser.add_argument('config', help='test config file path', default='models/deblur_model/FGST/configs/FGST_deblur_dvd_test.py')
    parser.add_argument('checkpoint', help='checkpoint file', default='models/deblur_model/FGST/checkpoints/FGST_dvd.pth')
