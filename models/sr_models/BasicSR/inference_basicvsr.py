...
def main_worker_BasicVsr(model_path='models/sr_models/BasicSR/checkpoints/BasicVSR_REDS4-543c8261.pth', input_path='', save_path='', interval=7):
...
if __name__ == '__main__':
    main_worker_BasicVsr(model_path='models/BasicSR/checkpoints/BasicVSR_REDS4-543c8261.pth', input_path=r'C:\Users\YinXi\Documents\deepLearning\FGT\data\frames\bmx-bumps', save_path='../results/BasicVSR/bmx-bumps')
