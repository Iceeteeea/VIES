...
parser.add_argument("--ckpt_filter", default="models/deflicker_models/AIOD/checkpoints/neural_filter.pth",type=str, help="the ckpt of neural filter network")
parser.add_argument("--ckpt_local", default="models/deflicker_models/AIOD/checkpoints/local_refinement_net.pth", type=str, help="the ckpt of local refinement network")
...
if opts.class_name is None:
    atlas_generation_cmd = "python models/deflicker_models/AIOD/src/stage1_neural_atlas.py --vid_name {}".format(video_base_name)
    os.system(atlas_generation_cmd)
else:
    atlas_generation_cmd = "python models/deflicker_models/AIOD/src/stage1_neural_atlas_seg.py --vid_name {} --class_name {}".format(video_base_name, opts.class_name)
    os.system(atlas_generation_cmd)

neural_filter_and_refinement_cmd = "python models/deflicker_models/AIOD/src/neural_filter_and_refinement.py --video_name {} --fps {}".format(video_base_name, opts.fps)
