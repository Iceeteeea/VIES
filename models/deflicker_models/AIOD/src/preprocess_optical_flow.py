...
import argparse
from models.deflicker_models.AIOD.src.models.stage_1.raft_wrapper import RAFTWrapper
...
def preprocess(args):
    ...
    raft_wrapper = RAFTWrapper(
        model_path='models/deflicker_models/AIOD/checkpoints/raft-things.pth', max_long_edge=args.max_long_edge)
