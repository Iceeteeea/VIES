...
from models.deflicker_models.AIOD.src.models.stage_1.implicit_neural_networks import IMLP
from models.deflicker_models.AIOD.src.models.stage_1.evaluate import evaluate_model_single
from models.deflicker_models.AIOD.src.models.stage_1.loss_utils import get_gradient_loss_single, get_rigidity_loss, get_optical_flow_loss
from models.deflicker_models.AIOD.src.models.stage_1.unwrap_utils import get_tuples, pre_train_mapping, load_input_data_single, save_mask_flow
...
if __name__ == "__main__":
    ...
    config_path = "models/deflicker_models/AIOD/src/config/%s" % args.config
    vid_path = os.path.join(args.root, args.vid_name)

    args.vid_path = vid_path
    
    # get flow using current video
    cmd = "python models/deflicker_models/AIOD/src/preprocess_optical_flow.py --vid-path %s --gpu %s " % (vid_path, select_gpu)
    print(cmd)
